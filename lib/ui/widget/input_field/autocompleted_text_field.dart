...
class AutoCompleteTextFieldState<T> extends State<AutoCompleteTextField> {
  ...
  void updateSuggestions(List<T> suggestions,{bool isUpdate=false}) {
    this.suggestions = suggestions;
    if(isUpdate){
      filteredSuggestions= suggestions;
    }
    updateOverlay(currentText,isUpdate);
  }

  void updateOverlay([String? query,isUpdate=false]) {
    if ((listSuggestionsEntry == null && filteredSuggestions != null)|| isUpdate) {
